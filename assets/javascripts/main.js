(function () {
	...
	jquery.fn.animationsPlugin = function (data) {
	    if (data === 'destroy') ; else {
	        var $targetThis = jquery(this);
	        var $targetElement = $targetThis[0];
	        var $targetElementWidth = $targetElement.getBoundingClientRect().width;
	        var $rightEdge = $targetElement.getBoundingClientRect().right;
	        var $leftEdge = $targetElement.getBoundingClientRect().left;
	        var pageWidth = document.documentElement.clientWidth;
	        var oldRight = pageWidth - $rightEdge;
	        var newRight = pageWidth - $leftEdge;
	        var elementHided = false;
	...
	jquery.fn.validationsPlugin = function (data) {
	    ...
	    $targetForm.validate({
	            ...
	            tel1: {
	                ...
	                digits: {
	                    depends: function(element) {
	                        var firstPlus = element.value[0] === '+';
	                        var isDigids = Number(element.value.slice(1));
	        ...
	        submitHandler: function() {
	            $targetForm.fadeOut();
	            jquery('.form-modal-success').fadeIn();
	        },
	        showErrors: function(errorMap, errorList) {
	            jquery('.warning').css({display: 'none'});
	            errorList.forEach(function (error) {
	                var inputName = error.element.name;
	                var method = error.method;
	                var warningList = document.querySelectorAll('[data-name='+inputName+']');
	                warningList.forEach(function (warningItem) {
	    ...
	    jquery('.form-modal-success button').on('click', function () {
	        jquery('.form-modal-success').fadeOut();
	        $targetForm.fadeIn();
	    });
	};

	jquery.fn.lazyPlugin = function (data) {
	    var $targetElement = jquery(this)[0];
	...
	jquery.fn.rotatePlugin = function (data) {
	    var $targetThis = jquery(this);
	    var rotate = 0;
	    jquery(window).scroll(function () {
	        rotate = rotate + 5;
